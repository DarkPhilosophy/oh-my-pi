...
export class SessionMaintenance {
	...
	async checkCompaction(
		...
		// (the floor applied below) drive the decision instead. Usage from a fallback
		// or previous model was billed against a different context window, so it must
		// also be ignored for the current model's threshold decision.
