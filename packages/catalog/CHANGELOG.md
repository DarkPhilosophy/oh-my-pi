...
### Fixed
	...
	- Fixed extended-context maximum resolution repeating the full model-policy resolve per model on every rebuild; rule fallbacks are now memoized per model key.
