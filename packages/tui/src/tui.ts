...
export class TUI extends Container {
	...
	/**
	 * Schedule an ordinary render whose frame contains live streaming state.
	 *
	 * Identical scheduling to {@link requestRender}, but the frame is allowed
	 * through the larger live-output backlog budget so a fast-streaming reply
	 * keeps painting instead of stalling on the ordinary gate.
	 */
