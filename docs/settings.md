...
| `display.popupFill` | boolean | `false` | Opt in to the message-colored background fill for bordered command suggestion popups. Inline argument-completion lists are unchanged. |
